  ...
  return (
    <>
      <CalendarWrapper disabled={disabled}>
        <CalendarSubtitle $isDarkTheme={websiteTheme === "dark"}>Даты</CalendarSubtitle>
        <CalendarBlock>
          <CalendarNav>
            <CalendarMonth>
              {currentDate
            ...
            <NavActions>
              <NavAction disabled={disabled} onClick={prevMonth} data-action="prev">
                <svg
                width="6"
                height="11"
                viewBox="0 0 6 11"
              ...
              <NavAction disabled={disabled} onClick={nextMonth} data-action="next">
                <svg
                width="6"
                height="11"
                viewBox="0 0 6 11"
